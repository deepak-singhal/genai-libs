# We can do multiple things to optimize the RAG pipeline to yield best possible results :
# 1. Send complete documents in chunking strategy instead of set of characters or lines.
# 2. Increase/Decrease the overlapping window
# 3. Send more context to vector data retriever (by using kwargs=<value>) *****
...
###################### CREATE VECTORS DATA STORE WITH HUGGING FACE AS OPENAIEMBEDDING HAS ISSUE AND NEED#############################
